@EndUserText.label: 'Nhập xuất tồn số lượng, giá trị (class handle)'
@ObjectModel.query.implementedBy: 'ABAP:ZWM_CL_NXT_SLGT_CH'
define custom entity ZWM_I_NXT_SLGT_CH
  with parameters
    ...
    P_PeriodType : nsdm_period_type
{
  ...
  key FiscalYearVariant         : abap.char(2);
      ...
      @EndUserText.label        : 'Mã material cũ'
      @UI.lineItem              : [{ position: 14 }]
      @Consumption.filter.hidden: false
      yy1_materialfast_prd      : abap.char(20);
